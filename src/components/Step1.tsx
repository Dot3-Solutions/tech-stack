            ...
            <form id="step1Form" onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6 mt-6 ">
                ...
                <div>
                    <Controller
                        ...
                        control={control}
                        render={({ field }) =>
                            <InputField {...field} placeholder="ex. Google" label="Company name" required={true} />
                        }
                    />
                ...
                <div>
                    <Controller
                        ...
                        control={control}
                        render={({ field }) =>
                            <InputField {...field} placeholder="ex. Information Technology" label="Industry" required={true} />
